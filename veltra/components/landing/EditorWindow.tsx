...
type ClipTone = "purple" | "blue" | "teal";
...
function usePointerTilt(ref: React.RefObject<HTMLDivElement>) {
  useEffect(() => {
        ...
        <div className="window-tilt" ref={tiltRef}>
          <div className="window-float">
            <div
              className="window"
              role="img"
              aria-label="VidioCut Studio — video editor interface preview"
            >
              ...
              <div className="win-body">
                ...
                <div className="viewport">
                  <div className="canvas">
                    <span className="vc-chip vc-chip-tl">
                      <i className="rec" />
                      00:00:12:04
                    </span>
                    <span className="vc-chip vc-chip-tr">1920 × 1080 · 24 FPS</span>
                    <span className="vc-chip vc-chip-bl">Night_Drive_04.mp4</span>
